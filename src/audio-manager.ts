...
export class AudioManager {
    ...
    // Event subjects
    private trackStartSubject = new Subject<TrackStartEvent>();
    private trackEndSubject = new Subject<TrackEndEvent>();
    private loadCompleteSubject = new Subject<LoadCompleteEvent>();
    private errorSubject = new Subject<AudioErrorEvent>();
    ...
    private ensureGroupGain(group: string): GainNode {
    ...
    private async loadAndPlayOneShot(track: AudioTrack, key: string): Promise<void> {
        try {
    ...
    private playOneShotWithBuffer(track: AudioTrack, buffer: AudioBuffer, key: string): void {
        try {
            const ctx = this.ensureAudioContext();
    ...
    private cancelFade(channelId: string = DEFAULT_CHANNEL): void {
