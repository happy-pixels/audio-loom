...
export class OneShotPlayer {
    ...
    events;
    logger;
    constructor(context, groups, tracks, loader, events, logger) {
    ...
    playWithBuffer(track, buffer, key) {
        try {
...
//# sourceMappingURL=one-shot-player.js.map